...
class Profile extends AUTH_Controller {
	...
	public function update1() {
		//$this->form_validation->set_rules('nip', 'Username', 'trim|required|min_length[4]|max_length[15]');
		$this->form_validation->set_rules('nama_dosen', 'Nama', 'trim|required');
	...
	public function update2() {
		//$this->form_validation->set_rules('nip', 'Username', 'trim|required|min_length[4]|max_length[15]');
		$this->form_validation->set_rules('nama_mhs', 'Nama', 'trim|required');
		$this->form_validation->set_rules('jenis_kelamin', 'Jenis Kelamin', 'trim|required');
		$this->form_validation->set_rules('tempat_lahir', 'Tempat Lahir', 'trim|required');
		$this->form_validation->set_rules('tanggal_lahir', 'Tanggal Lahir', 'trim|required');
		$this->form_validation->set_rules('agama', 'Agama', 'trim|required');
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$result = $this->M_admin->update2($data, $id);
			$data['userdata'] 		= $this->M_admin->select2($id);
			$this->session->set_userdata('userdata', $data['userdata']);
			$this->userdata = $this->session->userdata('userdata');
	...
	public function ubah_password2() {
		$this->form_validation->set_rules('passLama', 'Password Lama', 'trim|required');
		$this->form_validation->set_rules('passBaru', 'Password Baru', 'trim|required');
		$this->form_validation->set_rules('passKonf', 'Password Konfirmasi', 'trim|required');
