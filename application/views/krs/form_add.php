                ...
                <div class="row">
                    ...
                    <form role="form" action="<?php echo base_url(); ?>krs/add" method="POST" onsubmit="return cekform();" id="frm1" name="frm1">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Pilih Jadwal KRS</label>
                                <select class="form-control select2" name="id_jadwal" id="id_jadwal" >
                                    <?php
                                        foreach ($jadwal as $j) { 
                                    ?>
                                    <option value="<?php echo $j->id_jadwal; ?>" ><?php echo $j->jenis." ".$j->nama_makul." - SKS: ".$j->sks." - ".$j->hari." ".substr($j->jam,0,5)." - Ruang: ".$j->nama_ruang; ?></option>
                                    <?php } ?>
                                </select>
            		        </div>
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" style="width: 100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center"><a href="javascript: deleteme(<?= $k->id_detailkrs?>)" onclick="return confirm('Anda yakin akan menghapus data ini...!')">
                            ...
                            <tr>
                                <th align="right" colspan="3">Total SKS</th>
                                <th colspan="4"><?= $totalsks?></th>
                        </table>
                    </div>
                </div>
                <!-- /.row (nested) -->
