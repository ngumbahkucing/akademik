                        ...
                        <div class="form-group">
                          ...
                          <select name="nip" class="form-control select2">
                            <?php foreach ($dosen as $d) { ?>
                              <option value="<?php echo $d->nip; ?>" <?php if($d->nip == $m->nip){echo "selected='selected'";} ?>><?php echo $d->nama_dosen; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                        <div class="form-group">
                          <label>Program Studi</label><br>
                          <select name="id_progdi" class="form-control select2">
                            <?php foreach ($progdi as $p) { ?>
                              <option value="<?php echo $p->id_progdi; ?>" <?php if($p->id_progdi == $m->id_progdi){echo "selected='selected'";} ?>><?php echo $p->nama_progdi; ?></option>
                            <?php } ?>
                          </select>
                        </div>
        				      	<div class="form-group">
